...
At QPG, I worked for about a year on gradient descent methods to
find pulses that can be generated by an Arbitrary Waveform Generator
that can optimally control a number of spins spread out on a diamond.
